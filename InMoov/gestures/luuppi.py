def luuppi():
  ...
  i01.setArmSpeed("right", 0.1, 0.1, 0.1, 0.1);
  i01.setArmSpeed("left", 0.1, 0.1, 0.1, 0.1);
  i01.setHeadSpeed(0.1, 0.1)
  # only the last value matters for hands
  i01.setHandSpeed("right", 0.75, 0.75, 0.75, 0.75, 0.75, 0.1)
  i01.setHandSpeed("left", 0.75, 0.75, 0.75, 0.75, 0.75, 0.1)
  # only first value matters for torso
  i01.setTorsoSpeed(0.1, 0.1, 0.1)
